...
import { pgTable, text, timestamp, integer, jsonb, index, foreignKey } from 'drizzle-orm/pg-core';
...
export const analyticsEvents = pgTable("analytics_events", {
  ...
  index("analytics_events_platform_idx").using("btree", table.platform.asc().nullsLast().op("text_ops")),
