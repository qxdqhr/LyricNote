              ...
              <div className="flex items-center justify-between">
                ...
                {totalEvents > 0 && !loading && (
                  <span className="text-sm text-gray-500">
                    显示 {(currentPage - 1) * pageSize + 1}-{Math.min(currentPage * pageSize, totalEvents)} / {totalEvents.toLocaleString()}
                  </span>
                )}
              </div>
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-between bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 rounded-xl border border-gray-200">
                  <div className="hidden sm:block text-sm text-gray-600">
                    第 <span className="font-semibold text-gray-900">{currentPage}</span> 页，共 <span className="font-semibold text-gray-900">{totalPages}</span> 页
                  </div>
              ...
              <div className="space-y-5">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-200">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-3 pt-2">
                      <div>
                        <span className="text-xs font-medium text-gray-600 block mb-1">事件类型</span>
                        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">
                          {selectedEvent.eventType}
                        </span>
                      </div>
                      <div>
                        <span className="text-xs font-medium text-gray-600 block mb-1">事件名称</span>
                        <p className="text-sm font-medium text-gray-900 truncate">{selectedEvent.eventName}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                    ...
                    <p className="text-sm font-semibold text-gray-900">{selectedEvent.appVersion}</p>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 border border-purple-200">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-900">{selectedEvent.userId || <span className="text-gray-400">游客</span>}</p>
                    </div>
                    <div>
                ...
                {(selectedEvent.pageUrl || selectedEvent.pageTitle) && (
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200">
                    ...
                    {selectedEvent.pageTitle && (
                      <div className="mb-2">
                        <span className="text-xs font-medium text-gray-600 block mb-1">页面标题</span>
                        <p className="text-sm font-medium text-gray-900">{selectedEvent.pageTitle}</p>
                      </div>
                    )}
                    {selectedEvent.pageUrl && (
                      <div>
                        <span className="text-xs font-medium text-gray-600 block mb-1">页面URL</span>
