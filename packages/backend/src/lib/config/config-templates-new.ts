...
export const NEW_CONFIG_TEMPLATES: Record<string, ConfigItem[]> = {
  ...
  [ConfigCategory.WECHAT]: [
    // 网页应用配置
    {
      key: 'wechat_web_appid',
      value: '',
      category: ConfigCategory.WECHAT,
      type: ConfigType.STRING,
      isRequired: false,
      isSensitive: false,
      description: '微信网页应用 AppID（用于PC网页扫码登录）',
      defaultValue: '',
      group: '网页应用',
    },
    {
      key: 'wechat_web_appsecret',
      value: '',
      category: ConfigCategory.WECHAT,
      type: ConfigType.STRING,
      isRequired: false,
      isSensitive: true,
      description: '微信网页应用 AppSecret',
      defaultValue: '',
      group: '网页应用',
    },
    // 小程序配置
    {
      key: 'wechat_miniapp_appid',
      value: '',
      category: ConfigCategory.WECHAT,
      type: ConfigType.STRING,
      isRequired: false,
    ...
    // 移动应用配置
    {
      key: 'wechat_mobile_appid',
      value: '',
      category: ConfigCategory.WECHAT,
      type: ConfigType.STRING,
      isRequired: false,
      isSensitive: false,
      description: '微信移动应用 AppID（用于iOS/Android APP登录）',
      defaultValue: '',
      group: '移动应用',
    },
    {
      key: 'wechat_mobile_appsecret',
      value: '',
      category: ConfigCategory.WECHAT,
      type: ConfigType.STRING,
      isRequired: false,
      isSensitive: true,
      description: '微信移动应用 AppSecret',
      defaultValue: '',
      group: '移动应用',
    },
    // 微信支付配置
    ...
    },
    {
      ...
      isRequired: false,
      isSensitive: true,
      description: '微信支付商户API密钥（32位）',
      defaultValue: '',
      group: '支付配置',
    },
    {
      key: 'wechat_cert_path',
      value: '',
      category: ConfigCategory.WECHAT,
      type: ConfigType.STRING,
      isRequired: false,
      isSensitive: false,
      description: '微信支付商户证书路径（绝对路径，例如：/path/to/certs/wechat/）',
      defaultValue: '',
      group: '支付配置',
    },
    {
