      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            {APP_TITLES.admin}
            {isDevelopment && (
              <span className="text-lg text-orange-600 ml-2 font-normal">开发环境</span>
            )}
          </h1>
          <p className="text-gray-600">{APP_CONFIG.description}</p>
          <p className="text-sm text-gray-500 mt-2">Powered by Better Auth</p>
          {autoFilled && (
            <p className="text-xs text-green-600 mt-1 font-medium">✨ 已自动填充测试账户信息</p>
          )}
        </div>
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-1 pb-6">
            ...
            <CardDescription className="text-center">请使用管理员账户登录系统</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 text-center space-y-2">
              <p className="text-sm text-gray-500">仅限管理员访问 • 系统安全保护</p>
            ...
            <CardContent className="pt-6">
              <div className="text-center space-y-3">
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <p className="text-sm text-amber-800 font-medium">开发环境 - 测试模式</p>
                </div>
