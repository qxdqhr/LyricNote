...
export const configDefinitions = pgTable("config_definitions", {
	...
	uniqueIndex("config_definitions_key_key").using("btree", table.key.asc().nullsLast().op("text_ops")),
	index("config_definitions_category_idx").using("btree", table.category.asc().nullsLast().op("text_ops")),
	index("config_definitions_status_idx").using("btree", table.status.asc().nullsLast().op("text_ops")),
]);
...
export const configHistory = pgTable("config_history", {
	...
	index("config_history_key_idx").using("btree", table.configKey.asc().nullsLast().op("text_ops")),
	index("config_history_date_idx").using("btree", table.changedAt.asc().nullsLast().op("timestamp_ops")),
]);
