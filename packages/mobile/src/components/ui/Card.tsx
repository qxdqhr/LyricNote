...
export function CardHeader({ children, className = '', style, ...props }: CardHeaderProps) {
  return (
    <View className={`p-6 pb-0 ${className}`} style={style} {...props}>
      {children}
    </View>
  );
}
...
export function CardTitle({ children, className = '', style, ...props }: CardTitleProps) {
  return (
    <Text className={`text-lg font-semibold text-gray-900 ${className}`} style={style} {...props}>
      {children}
    </Text>
  );
}
...
export function CardDescription({
  ...
  return (
    <Text className={`text-sm text-gray-600 mt-1 ${className}`} style={style} {...props}>
      {children}
    </Text>
  );
}
...
export function CardContent({ children, className = '', style, ...props }: CardContentProps) {
  return (
    <View className={`p-6 pt-0 ${className}`} style={style} {...props}>
      {children}
    </View>
  );
}
...
export function CardFooter({ children, className = '', style, ...props }: CardFooterProps) {
  return (
    <View className={`p-6 pt-0 flex-row items-center ${className}`} style={style} {...props}>
      {children}
    </View>
  );
}
